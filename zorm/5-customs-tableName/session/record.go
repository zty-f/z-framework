...
func (s *Session) Insert(values ...interface{}) (int64, error) {
	...
	for _, value := range values {
		s.CallMethodByInterface(BeforeInsert, value)
...
func (s *Session) Find(values interface{}) error {
	s.CallMethodByReflect(BeforeQuery, nil)
	...
	for rows.Next() {
		...
		s.CallMethodByReflect(AfterQuery, dest.Addr().Interface())
